use crate::commands::fs::OpenOptions;
use crate::files::get_last_not_path;
use chrono::Local;
...
// fn append_content(file_path: &str, content: &str) {
//     // add some conent
// }
...
pub fn append_film_viewing(
    ...
    println!("Found last `.md` file: {}", last_not_path.display());
